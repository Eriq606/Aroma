...
public class Constantes {
    ...
    public static final String col_nom_produit="nom";

    public static final String col_id_type="idtype";
    public static final String col_nom_type="nom_type";

    public static final String col_id_unite="idunite";
    public static final String col_nom_unite="nom_unite";

    public static final String col_id_fournisseur="id";
    ...
    public static final String col_date_report="date";
    ...
    public static final String col_date_transaction="date";
